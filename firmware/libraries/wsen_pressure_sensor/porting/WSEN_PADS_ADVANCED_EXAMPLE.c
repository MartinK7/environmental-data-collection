 ...
 */
int8_t WE_padsAdvancedExampleInit()
{
  char bufferMajor[4];
  char bufferMinor[4];
...
void PADS_startDataReadyInterruptExample()
{
  ...
  uint32_t printTime = systick_get() + printIntervalMs;
 ...
 */
int8_t PADS_startContinuousExample(uint32_t *pressure, int32_t *temperature)
{
